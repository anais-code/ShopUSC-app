...
<html lang="en">
    <head>
        ...
        <title>Shop USC | Buyer Login</title>
        ...
        <div class="container-sm d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-5 col-8">
                    <div style="display:block;">
                        <h1 class="text-center" style="color: #19B053; font-family:Merriweather, sans-serif; font-size: 50px; font-weight:bold; padding-top:2em; margin-top:-20px; margin-bottom: 50px;">Buyer Login</h1>
                        <form class="needs-validation" id="buyerLogin" action="<?= base_url('auth/loginBuyer') ?>" method="post" novalidate>
                            <div class="row mb-3">
                                <div class="col-md-12">
                        ...
                        <div class="d-flex justify-content-center mb-3">
                            <p>Not yet a member? <a href="<?= base_url('buyer_signup') ?>" style="color: rgb(253, 218, 70); font-weight:bold;" >Sign Up</a><p>
                        </div>
                    </div>
                </div>
